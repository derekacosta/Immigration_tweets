            ...
            <Grid
                gap={100}>
                    <div>                           <Des style={{
                        background: 'white',
                        boxShadow: '0 1px 5px rgba(0,0,0,0.5)'
                    }}>This is very similar to example 5. What is different here is that the statement does not seem to group “illegal aliens” and “refugees” into a single category. By placing “not” in front of each term, it shows more clearly that these two ideas are largely independent from each other. </Des>
